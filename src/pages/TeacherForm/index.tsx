...
function TeacherForm() {
  ...
  function handleCreateClass(e: FormEvent) {
    ...
    api.post('classes', {
      ...
      alert('Register made successfully!');
  ...
  return (
    <div id="page-teacher-form" className="container">
      <PageHeader
        title="That's incredible, you want to teach"
        description="First of all, you need to fill out the form down below"
      />
        ...
        <form onSubmit={handleCreateClass}>
          ...
          <footer>
            <p>
              ...
              Important! <br />
              Fill in blank spaces with required information
            </p>
